...
import 'package:red_bull_flutter_case_study/src/sheet/src/route/sheet_route.dart';
import 'package:red_bull_flutter_case_study/src/sheet/src/sheet.dart';
...
class CupertinoSheetBottomRouteTransition extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final double topPadding = MediaQuery.of(context).padding.top;
    final double topOffset = math.max(_kSheetMinimalOffset, topPadding) +
        (!visible ? _kPreviousRouteVisibleOffset : 0);
    ...
    return AnnotatedRegion<SystemUiOverlayStyle>(
      ...
      child: AnimatedBuilder(
        ...
        builder: (BuildContext context, Widget? child) {
          ...
          return Stack(
            children: <Widget>[
              Container(color: backgroundColor ?? Colors.black),
